...
import { SMOL_RACING_ADDRESS } from "@treasure/constants";

import {
  RandomRequest,
  RandomSeeded,
} from "../../generated/Randomizer/Randomizer";
import { Race, Random, Seeded } from "../../generated/schema";
...
export function handleRandomRequest(event: RandomRequest): void {
  ...
  if (
    ...
    (event.transaction.to as Address).notEqual(SMOL_RACING_ADDRESS)
  ) {
    log.debug(
