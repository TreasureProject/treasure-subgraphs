...
export const createSmolStakedEvent = (
  ...
  event.parameters = [
    ...
    new ethereum.EventParam(
      "_smolAddress",
      ethereum.Value.fromAddress(SMOL_BODIES_ADDRESS)
    ),
...
export const createStartClaimingEvent = (
  ...
  event.parameters = [
    ...
    new ethereum.EventParam(
      "_numberRewards",
      ethereum.Value.fromI32(numRewards)
    ),
  ];
...
export const createRewardClaimedEvent = (
  ...
  event.parameters = [
    ...
    new ethereum.EventParam(
      "_claimedRewardId",
      ethereum.Value.fromI32(rewardTokenId)
    ),
    new ethereum.EventParam("_amount", ethereum.Value.fromI32(1)),
  ];
